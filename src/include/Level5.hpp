...
GameData gamedata;
DataLoader dl;
    TilemapImporter tmpimp = TilemapImporter("level5.json", "Textures/tilemap1.png");
    AI ai = AI("Textures/Char/6.png", {27*32,9*32},2.5f, 32, 32, {4,3}, 0.2f, 6);
    
    vector<AI> ais = {ai};
    vector<Wall> walls;
    vector<Sprite> bottom;
    Goal g = Goal("Textures/Goal.png", {24*32, 23*32}, 6); 
